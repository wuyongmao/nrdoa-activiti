...
import com.ruoyi.activiti.imgUtil.DefaultProcessDiagramGenerator;
...
public class ActivitiConfig {
	...
	public ProcessEngineConfiguration processEngineConfiguration(DataSource dataSource,
		 ...
		 * "false";操作activiti23张表的时候，如果表不存在，就抛出异常，不能自动创建23张表
		 * 
...
//      processEngineConfiguration.setProcessDiagramGenerator(new HMProcessDiagramGenerator());
		processEngineConfiguration.setProcessDiagramGenerator(new DefaultProcessDiagramGenerator());
